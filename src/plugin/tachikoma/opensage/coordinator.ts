/**
 * OpenSage Coordinator
 *
 * Orchestrates agent topology, graph routing, memory indexing, and verification.
 *
 * MCP Integration:
 * - Topology analysis via tachikoma-mcp_analyze_topology
 * - Memory indexing via tachikoma-mcp_enhanced_rlm_process (internal use)
 * - Verification via tachikoma-mcp_execute_with_verification
 *
